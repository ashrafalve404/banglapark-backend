...
export class UsersService {
    ...
    async getStatement(id: string) {
        ...
        const [
            ...
            tierBonusAgg,
            generationIncomeAgg,
            digitalMarketingIncomeAgg,
            digitalMarketingSpentAgg,
            quizIncomeAgg,
            sellerIncomeAgg,
            positionSalaryAgg,
            depositAgg,
            approvedWithdrawalAgg,
            transferInAgg,
            transferOutAgg,
            giftCardSpentAgg,
            cpaSpentAgg,
            ...
            // Digital Marketing Daily Returns sum
            this.prisma.walletTransaction.aggregate({
                where: { wallet: { userId: id }, type: 'DIGITAL_MARKETING_RETURN' },
                _sum: { amount: true },
            }),
            // Digital Marketing Purchase sum
            this.prisma.walletTransaction.aggregate({
            ...
            // Total Approved Withdrawals sum
