...
let EmailService = EmailService_1 = class EmailService {
    ...
    constructor(configService) {
        ...
        this.fromEmail = this.configService.get('RESEND_FROM_EMAIL') || process.env.RESEND_FROM_EMAIL || 'Bangla Park <onboarding@resend.dev>';
        if (apiKey) {
    ...
    async sendVerificationEmail(toEmail, name, otp) {
