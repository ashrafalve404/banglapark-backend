...
let CommissionController = class CommissionController {
    ...
    getMyCommissions(userId, page = 1, limit = 20) {
        return this.commissionService.getCommissionReport(+page, +limit, userId);
    }
    getAllCommissions(page = 1, limit = 20) {
...
__decorate([
    (0, common_1.Get)('my'),
    (0, swagger_1.ApiOperation)({ summary: 'Get my received commissions' }),
...
], CommissionController.prototype, "getMyCommissions", null);
__decorate([
    (0, common_1.Get)('admin/all'),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.SUPER_ADMIN),
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Get all commission payouts' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }),
